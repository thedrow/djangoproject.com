...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('aggregator_claimrequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('feed', self.gf('django.db.models.fields.related.ForeignKey')(related_name='claim_requests', to=orm['aggregator.Feed'])),
            ('claimant', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('date_requested', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('aggregator', ['ClaimRequest'])


    def backwards(self, orm):
        
        # Deleting model 'ClaimRequest'
        db.delete_table('aggregator_claimrequest')


    models = {
        'aggregator.claimrequest': {
            'Meta': {'ordering': "['-date_requested']", 'object_name': 'ClaimRequest'},
            'claimant': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['auth.User']"}),
            'date_requested': ('django.db.models.fields.DateTimeField', [], {}),
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'claim_requests'", 'to': "orm['aggregator.Feed']"}),
